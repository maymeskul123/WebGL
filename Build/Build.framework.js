...
var ASM_CONSTS = {
  4384260: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 4384315: ($0) => { performance.now = function() { return $0; }; },  
 4384363: ($0) => { performance.now = function() { return $0; }; },  
 4384411: () => { performance.now = Module['emscripten_get_now_backup']; }
};
